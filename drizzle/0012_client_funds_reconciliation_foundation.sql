...
CREATE TABLE "reconciliation_matches" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "match_player_transaction_unique" UNIQUE("player_transaction_id"),
	CONSTRAINT "match_psp_transaction_unique" UNIQUE("psp_transaction_id")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "match_player_psp_unique" ON "reconciliation_matches" USING btree ("company_id","player_transaction_id","psp_transaction_id");