...
export interface Messages {
  ...
  reconciliation: {
    ...
    disclaimer: string;
    noCompany: string;
    importLedgerTitle: string;
    importLedgerDesc: string;
    importLedgerButton: string;
    importLedgerDone: string;
    importPspTitle: string;
    importPspDesc: string;
    importPspButton: string;
    ...
    matchStatus: string;
    matchLinked: string;
    matchLinkedPsp: string;
    matchLinkedLedger: string;
  ...
  paymentAccounts: {
    ...
    actions: string; editTransaction: string; deleteTransaction: string; reference: string; editBusinessFactsOnly: string; reviewChanges: string; confirmTransactionChanges: string; changedValues: string; confirmChanges: string; back: string; cancel: string; delete: string; saving: string; deleting: string; deleteTransactionQuestion: string; transactionDeleteConfirmation: string; transactionChangeFailed: string; transactionDeleteFailed: string;
    deleteAccount: string; deleteNamedAccountQuestion: string; accountDeleteConfirmation: string; accountDeleteFailed: string;
