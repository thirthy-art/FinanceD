...
import type { PaymentEventType } from "@/src/lib/payment-ledger";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (body.kind === "fee" && typeof body.eventType === "string" && typeof body.percentageRate === "string" && typeof body.fixedAmount === "string") {
      return NextResponse.json({ rule: await createFeeRule(company.id, { paymentAccountId: body.paymentAccountId, eventType: body.eventType as PaymentEventType, assetCode: typeof body.assetCode === "string" ? body.assetCode : null, percentageRate: body.percentageRate, fixedAmount: body.fixedAmount, fixedAssetCode: typeof body.fixedAssetCode === "string" ? body.fixedAssetCode : null, effectiveFrom: body.effectiveFrom, effectiveTo: typeof body.effectiveTo === "string" ? body.effectiveTo : null }) });
    }
